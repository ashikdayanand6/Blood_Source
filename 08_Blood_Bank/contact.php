    ...
    <div class="container" style="margin-top:70px;">
                ...
                <form method="post" action="contact.php" role="form" >
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="tel" maxlength="10" pattern={0-9}[10] class="form-control" name="phone" required>
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
            ...
            <div class="col-md-4">
                ...
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>  7229082507 </p>
                    <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr> 8971745512 </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="#" >bloodsourcein@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">W</abbr>: <a href="index.php">www.bloodsource.org</a></p>
