                ...
                <div class="panel panel-primary">
					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
								<label class="control-label text-primary">Unit Of Blood Required</label>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						   ...
						   <div class="form-group">
                                ...
                                <input type="tel" maxlength="6" pattern={0-9}[6] required name="PIN" id="PIN" class="form-control" placeholder="Insert Pincode">
                          </div>
						  <div class="form-group">
						...
						<div class="form-group">
							...
							<input type="tel" maxlength="10" pattern={0-9}[10] placeholder="Contact Number" class="form-control input-sm" name="CON1" id="CON1">
						</div>
							<div class="form-group">
							<label class="control-label text-primary">Contact No-2</label>
							<input type="tel" maxlength="10" pattern={0-9}[10] placeholder="Contact Number" class="form-control input-sm" name="CON2" id="CON2">
						</div>
						<div class="form-group">
