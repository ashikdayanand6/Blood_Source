                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							...
							<input type="number" required placeholder="Weight In Kgs"  name="BODY_WEIGHT" id="BODY_WEIGHT" class="form-control input-sm">
						</div>
						 <div class="form-group">
						  ...
						  <div class="form-group">
                                ...
                                <input type="number" required name="PINCODE" id="PINCODE" class="form-control" placeholder="Insert Pincode">
                          </div>
						   ...
						   <div class="form-group">
                                ...
                                <input type="tel" required name="CONTACT_1" id="CONTACT_1" class="form-control" placeholder="Contact No-1" maxlength="10" minlength="10" pattern=[0-9]{10}>
                          </div>
						   <div class="form-group">
								<label class="control-label text-primary" for="CONTACT_2" >Contact-2</label>
                                <input type="tel" required name="CONTACT_2" id="CONTACT_2" class="form-control" placeholder="Contact No-2" maxlength="10" minlength="10" pattern=[0-9]{10}>
                          </div>
						  <hr>
						   <div class="form-group">
						...
						<div class="form-group">
						  ...
						  <div class="form-group" id="new">
							...
							<input type="file" class="form-control"  name="fileToUpload">
							  ...
							  <div class="form-group">
								<label class="control-label text-success"><input type="checkbox" unchecked id="c2">&nbsp; I have read the eligibility criteria and confirm that i am eligible to donate blood.</label> 
								<label class="control-label text-success"><input type="checkbox" unchecked id="c3" >&nbsp; I agree to the Term and Conditions and consent to have my contact and donor information published to the potential blood recipients.</label>
						  </div>
